...
function Home() {
  return (
    <div className='h-screen bg-customGradient'>
      <div className='flex justify-center '>
        <div className=' px-60 py-20 rounded-lg shadow-2xl mt-20'>
          <h1 className='drop-shadow-lg font-casual text-8xl font-bold text-center text-white mb-3'>
            Kick Off your influencer
          </h1>
          <h1 className='drop-shadow-lg font-casual text-8xl font-bold text-center text-white '>
            campaign today
          </h1>
          <p className='drop-shadow-md font-medium font-sans text-3xl text-center mt-16 '>
            Gimmick facilitates the smooth initiation and growth of your
          </p>
          <p className='drop-shadow-md font-medium font-sans text-3xl text-center mt-2 '>
